/* Roles & access for SkillCat Admins — rendered as the "Permissions" tab of
   the Product Config page (it has no sidebar entry of its own). Nothing is
   configurable yet, so the tab is one empty state filling its body; the tab
   label already names it, so there is no heading above it. */
export function PermissionsSection() {
  return (
    <div className="co-empty-state pc-empty">
